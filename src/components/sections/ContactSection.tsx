    ...
    const onSubmit = async (data: FormData) => {
        ...
        try {
            ...
            setFormStatus({
                type: "error",
                message:
                    "Hubo un error al procesar la solicitud. Por favor, inténtalo más tarde.",
            });
        } finally {
            ...
            <div className="container">
                ...
                >
                    ...
                    <p className="max-w-2xl mx-auto text-gray-600">
                        Danos la oportunidad de conocerte, estamos seguros de
                        poder ayudarte. Completa el formulario y nuestro equipo
                        de expertos se pondrá en contacto contigo a la brevedad.
                    </p>
                </motion.div>
                            ...
                            <div className="space-y-6 flex-grow">
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3">
                                        ...
                                        <p className="text-gray-600 mt-1">
                                            Av. Coyoacán 1435, Centro Urbano
                                            Presidente Alemán, Edificio H,
                                            Despacho 60-B,
                                            <br />
                                            Col. Del Valle, C.P. 03100, Ciudad
                                            de México
                                            <br />
                                            (Esquina de Parroquia y Coyoacán,
                                            Planta Baja del Centro Urbano
                                            Presidente Alemán)
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3">
                                        ...
                                        <p className="text-gray-600 mt-1">
                                            Lunes a Viernes: 9:30 AM - 2:30 PM y
                                            3:30 PM - 6:00 PM
                                        </p>
                                    </div>
                                </div>
